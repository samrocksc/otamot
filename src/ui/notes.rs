            ...
            .show(ui, |ui| {
                ui.vertical(|ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        let edit_color = if edit_active {
                            active_color
                        } else {
                            inactive_color
                        };
                        let edit_text_color = if edit_active {
                        ...
                        let preview_color = if preview_active {
                            active_color
                        } else {
                            inactive_color
                        };
                        let preview_text_color = if preview_active {
                            text_highlight_color
                        } else {
                            text_color
                        };
                        ...
                        let project_color = if project_active {
                            active_color
                        } else {
                            inactive_color
                        };
                        let project_text_color = if project_active {
                            text_highlight_color
                        } else {
                            text_color
                        };
                        ...
                        .clicked()
                        {
                            ...
                            *self.project_content =
                                std::fs::read_to_string(todo_file).unwrap_or_default();
                            *self.focus_input = true;
                        }
                    });
                    ...
                    match *self.view {
                        NotesView::Edit => {
                            ...
                            let save_shortcut_pressed =
                                ctx.input(|i| i.key_pressed(egui::Key::S) && i.modifiers.command);
                        ...
                        NotesView::Preview => {
                            ...
                            ui_components::render_markdown_preview(
                                ui,
                                self.content,
                                text_color,
                                bg_color,
                        ...
                        NotesView::Project => {
                            ...
                            ui.add(
                                egui::TextEdit::multiline(self.project_content)
