...
impl<'a> Sidebar<'a> {
    pub fn show(&mut self, ui: &mut egui::Ui, button_color: egui::Color32, button_text_color: egui::Color32, text_dim_color: egui::Color32) {
        ui.vertical(|ui| {
            ...
            if ui_components::sidebar_icon_button(ui, arrow, button_text_color, button_color).clicked() {
            ...
            if !*self.sidebar_collapsed {
                ...
                // Settings button
                if ui_components::sidebar_button(ui, &self.t.settings_btn(), button_text_color, button_color).clicked() {
                    *self.show_settings = true;
                }

                // Survey summary button
                ui.add_space(8.0);
                if ui_components::sidebar_button(ui, &self.t.survey_summary_title(), button_text_color, button_color).clicked() {
                    *self.show_survey_summary = true;
                }

                // Divider with smaller padding
                ui.add_space(12.0);
                ...
                if ui_components::sidebar_button(ui, &notes_label, button_text_color, button_color).clicked() {
                ...
                if ui_components::sidebar_button(ui, &todo_label, button_text_color, button_color).clicked() {
                ...
                if ui_components::sidebar_button(ui, kanban_label, button_text_color, button_color).clicked() {
                ...
                if ui_components::sidebar_button(ui, &self.t.help_button(), button_text_color, button_color).clicked() {
